        ...
        >
            ...
            <div className="main">
                <div className="main-page">
                    <div className="add-task" style={{ position: 'relative', zIndex: !props.step && '100' }}>
                        <input className="add-task__input" placeholder="Add your task name" />
                        <svg
                            style={{ marginRight: '15px', zIndex: props.step === 1 && '100' }}
                        ...
                        <span className="add-task__duration">
                            {props.step === 3 || props.step === 4 ? '00:15:24' : '00:00:00'}
                        </span>
                        ...
                        <ArrowPointerBox step={props.step} />
                    </div>
                    <div>
            ...
            {props.step !== 4 ? (
                <div className="middle-buttons">
                    ...
                    <div className="middle-buttons__steps">
                        <button style={{ backgroundColor: '#EB5757' }} onClick={props.prevPage}>
                            Previous Step
                        </button>
