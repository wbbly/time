        ...
        client
            .request(
                changeTimeMutation({
                    ...
                    startDatetime: moment(`${moment(this.state.startDate).format('YYYY-MM-DD')} ${moment(this.state.startTime).format('HH:mm')}`).utc().format(),
                    endDatetime: moment(`${moment(this.state.endDate).format('YYYY-MM-DD')} ${moment(this.state.endTime).format('HH:mm')}`).utc().format(),
                })
            )
            .then(data => {
                this.getNewData();
                    ...
                    <div className="manual_timer_modal_timepickers_container">
                        <div className="margin_12">
                            ...
                            <div className="date_time">
                                ...
                                <TimeFormatInput value={ startTime } onChange={e => this.onChangeTime(e)} name='time-input'/>
                            </div>
                        </div>
                        <div className="margin_12">
                            <span>Time end:</span>
