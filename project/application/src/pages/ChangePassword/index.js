...
//                             />
//                             <i
//                                 className="visible_password_eye"
//                                 onClick={e => this.changeVisiblePassword('currentPassword')}
//                             />
//                         </div>
//                     </div>
//                     <div className="change_password_modal_data">
...
//                             <i
//                                 className="visible_password_eye"
//                                 onClick={e => this.changeVisiblePassword('newPassword')}
//                             />
//                         </div>
//                     </div>
//                     <div className="change_password_modal_data">
...
//                             />
//                             <i className="visible_password_eye" onClick={e => this.changeVisiblePassword('repeat')} />
//                         </div>
//                     </div>
