export default {
    ...
    'SUCCESS.USER.DELETE_USER_FROM_TEAM_FAILED': 'Der Benutzer wurde erfolgreich aus dem Team gelöscht.',
    'SUCCESS.USER.DELETE_USER_FROM_TEAM_SUCCEED': 'Der Benutzer wurde erfolgreich aus dem Team gelöscht.',
    'ERROR.USER.DELETE_USER_FROM_TEAM_FAILED': 'Beim Löschen aus dem Team ist ein Fehler aufgetreten.',

    v_a_avatar_upload_error: 'Ladefehler! Die Download-Datei ist kein Bild oder ihre Größe überschreitet 1 MB.',
    ...
    v_sync_with_jira_project_exist: 'Das Jira-Projekt ist bereits mit dem Projekt "{{projectName}}" verbunden',
    ...
    v_no_projects_sub: 'Bitten Sie Ihren Teamadministrator, Sie zum Projekt hinzuzufügen',
    ...
    v_client_no_email: 'Die E-Mail des Kunden ist nicht ausgefüllt',
    v_add_part_of_payment: 'Fügen Sie einen Teil der Zahlung hinzu',
