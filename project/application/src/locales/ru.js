export default {
    ...
    v_sync_with_jira_project_exist: 'Проект Jira уже подключен к проекту "{{projectName}}"',
    ...
    v_no_projects_sub: 'Попросите администратора вашей команды добавить вас в проект',
    ...
    v_edit_confirmation_window: 'Счет уже был отослан клиенту, вы уверены что хотите отредактировать?',
    v_client_no_email: 'Электронная почта клиента не заполнена',
    v_add_part_of_payment: 'Добавить часть оплаты',
