export default {
    ...
    v_sync_with_jira_project_exist: 'Проект Jira вже підключений до проекту "{{projectName}}"',
    ...
    v_no_projects_sub: 'Попросіть адміністратора вашої команди додати вас до проекту',
    ...
    v_edit_confirmation_window: 'Рахунок вже був відісланий клієнту, ви впевнені що хочете відредагувати?',
    v_client_no_email: 'Електронна пошта клієнта не заповнена',
    v_add_part_of_payment: 'Додайте частину платежу',
