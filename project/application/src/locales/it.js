export default {
    ...
    'ERROR.TEAM.SWITCH_FAILED': 'Si è verificato un errore durante il cambio di squadra.',
    'ERROR.TEAM.RENAME_FAILED': 'Si è verificato un errore durante la ridenominazione della squadra.',
    ...
    'SUCCESS.USER.DELETE_USER_FROM_TEAM_FAILED': 'L’utente è stato cancellato con successo dalla squadra.',
    'SUCCESS.USER.DELETE_USER_FROM_TEAM_SUCCEED': 'L’utente è stato cancellato con successo dalla squadra.',
    'ERROR.USER.DELETE_USER_FROM_TEAM_FAILED': 'Si è verificato un errore durante l’eliminazione dalla squadra.',
    ...
    v_sync_with_jira_project_exist: 'Il progetto Jira è già collegato al progetto "{{projectName}}"',
    ...
    v_no_projects_sub: "Chiedi all'amministratore del tuo team di aggiungerti al progetto",
    ...
    v_edit_confirmation_window: 'La fattura è già stata inviata al cliente, sei sicuro di volerla modificare?',
    v_client_no_email: "L'e-mail del cliente non è stata compilata",
    v_add_part_of_payment: 'Aggiungi una parte del pagamento',
