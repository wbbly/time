export default {
    ...
    v_sync_with_jira_project_exist: 'Jira project is already connected to the project "{{projectName}}"',
    ...
    v_edit_confirmation_window: 'The invoice has already been sent to the client, are you sure you want to edit?',
    v_client_no_email: "The client's Email is not filled",
    v_add_part_of_payment: 'Add part of payment',
