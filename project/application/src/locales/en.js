export default {
    ...
    v_address: 'Address',
    v_select_logo_file_bigger: 'Drag Photo Here Or Select A File',
    v_billing_code_error: 'Invalid zip code',
    v_zip_code: 'Zip',
    v_enter_country: 'Enter country',
    v_country: 'Country',
    v_city: 'City',
    v_street: 'Street',
    v_state: 'State',
    v_enter_text: 'Enter text',
    v_enter_number: 'Enter Number',
    v_enter_city: 'Enter city',
    v_enter_language: 'Choose Language',
