...
var defineds = {
  startOfWeek: (0, _startOfWeek2.default)(new Date(), {weekStartsOn: 1}),
  endOfWeek: (0, _endOfWeek2.default)(new Date(), {weekStartsOn: 1}),
  startOfLastWeek: (0, _startOfWeek2.default)((0, _addDays2.default)(new Date(), -7), {weekStartsOn: 1}),
  endOfLastWeek: (0, _endOfWeek2.default)((0, _addDays2.default)(new Date(), -7), {weekStartsOn: 1}),
